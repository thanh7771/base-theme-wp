...
if ( ! function_exists( 'xenia_adjust_body_class' ) ) {
	 ...
	 */
	function xenia_adjust_body_class( $classes ) {
...
if ( ! function_exists( 'xenia_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function xenia_slbd_count_widgets( $sidebar_id ) {
...
function deprecated_translations() {
	array(
		__( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'xenia' ),
		__( 'Previous', 'xenia' ),
		__( 'Next', 'xenia' ),
		__( 'About:', 'xenia' ),
		__( 'Profile', 'xenia' ),
		__( 'Posts by', 'xenia' ),
		__( 'Permanent Link:', 'xenia' ),
		__( 'in', 'xenia' ),
		__( 'Edit', 'xenia' ),
	);
}
