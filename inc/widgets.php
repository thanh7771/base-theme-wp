 ...
 */
add_filter( 'dynamic_sidebar_params', 'xenia_widget_classes' );

if ( ! function_exists( 'xenia_widget_classes' ) ) {
	 ...
	 * @return array $params
	 */
	function xenia_widget_classes( $params ) {
...
} // End of if function_exists( 'xenia_widget_classes' ).

add_action( 'widgets_init', 'xenia_widgets_init' );

if ( ! function_exists( 'xenia_widgets_init' ) ) {
	/**
	 * Initializes themes widgets.
	 */
	function xenia_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Footer 1', 'xenia' ),
				'id'            => 'footer-1',
				'description'   => __( 'Footer 1 widget area', 'xenia' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer 2', 'xenia' ),
				'id'            => 'footer-2',
				'description'   => __( 'Footer 2 widget area', 'xenia' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer 3', 'xenia' ),
				'id'            => 'footer-3',
				'description'   => __( 'Footer 3 widget area', 'xenia' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
...
} // endif function_exists( 'xenia_widgets_init' ).
